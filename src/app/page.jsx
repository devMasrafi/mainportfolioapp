        ...
        <div className="container mx-auto">
          ...
          <div className="flex lg:mt-[8rem] lg:justify-evenly ">
            ...
            <div className="lg:w-[34rem] ">
              <h2 className="lg:text-3xl lg:font-bold capitalize tracking-wider lg:pb-4 ">my journey</h2>
